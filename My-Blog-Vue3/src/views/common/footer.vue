    ...
    <div id="footer_content">
      <div class="footer-group">
        ...
        <div class="footer-links">
          <a class="footer-item" @click="toUrl('/tools')" href="javascript:;" data-pjax-state=""
            >藏宝阁</a
          >
          <a class="footer-item" @click="toUrl('/friend')" href="javascript:;" data-pjax-state=""
            >友链</a
          >
          <a class="footer-item" @click="toUrl('/message')" href="javascript:;" data-pjax-state=""
            >留言厅</a
          >
          <a class="footer-item" @click="toUrl('/travel')" href="javascript:;" data-pjax-state=""
            >个人相册</a
          >
          <a class="footer-item" @click="toUrl('/funny')" href="javascript:;" data-pjax-state=""
            >幻音坊</a
          >
        </div>
      </div>
      <div class="footer-group">
        ...
        <div class="footer-links">
          ...
          <a
            ...
            >随想</a
          >
          <a class="footer-item" @click="toUrl('/sort')" href="javascript:;" data-pjax-state=""
            >查看全部</a
          >
        </div>
      </div>
    ...
    <div id="footer-bottom">
      <div class="footer-bottom-content">
        <div class="footer-bottom-left">
          <span
            ...
            <a
              ...
              href="javascript:;"
              @click="toUrl('/')"
              :title="`点击访问${constant.siteName}的主页`"
              >{{ constant.siteName }}
            </a>
          </span>
          <div>
        ...
        <div class="footer-bottom-right">
          <div id="runtime" title="本站已运行 1.10 坤年🐔🏀">本站已运行：{{ countdownChange }}</div>
          <div>
            <a
              class="footer-bottom-link"
              target="_blank"
...
const countdownTime = ref<string>("2023-08-13 00:00:00");
...
const copy = async (val: number): Promise<void> => {
  const number = val === 1 ? constant.qqNumber : constant.wechatId;
  ...
  notifySuccess(`本博主的${text}已经到你的剪贴板啦，快加入我们吧~~🎉`);
};
