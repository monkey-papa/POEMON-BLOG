<template>
  <dev>
    ...
    <button>
      ...
      <img class="✈️" :src="$store.state.webInfo.randomCover[2]" />
      <img class="🐻" :src="$store.state.webInfo.randomCover[3]" />
      <div class="⭕️"></div>
      <div class="💭">
        <div class="☁️"></div>
        <div class="☁️"></div>
...
input:not(:checked) + button > .✈️ {
  opacity: 1;
  transform: translate(-500px, -200px) rotate(0);
...
.🌟 .✨:nth-child(2) {
  ...
  left: 34px;
  transform: scale(0.6);
  animation: twinkle 4s -8s infinite;
}
.🌟 .✨:nth-child(3) {
  top: 56px;
  left: 64px;
...
.🌟 .✨:nth-child(6) {
  ...
  left: 70px;
  transform: scale(0.4);
  animation: twinkle-4 5s -10s infinite;
}
.🌟 .✨:nth-child(7) {
  top: 36px;
  left: 166px;
...
.🌟 .✨:nth-child(10) {
  ...
  left: 192px;
  transform: scale(0.4);
  animation: twinkle-4 4s -2s infinite;
}
.🌟 .✨:nth-child(11) {
  top: 90px;
  left: 172px;
  transform: scale(0.8);
  animation: twinkle 3s -3s infinite;
}
input:not(:checked) + button > .🌟 {
